...
- Runs use `codex exec --sandbox workspace-write -m gpt-5.5` by default. If an older CLI rejects that model, upgrade Codex or set `dispatch_model = "gpt-5.2"` in `config.toml`.
